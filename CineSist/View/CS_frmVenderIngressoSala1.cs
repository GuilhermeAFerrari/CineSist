...
namespace CineSist
{
    public partial class CS_frmVendaIngresso : Form
    {

      //criação de instância para usar o formulário CS_frmVendaIngresso
        private static CS_frmVendaIngresso frmVendaIngresso = null;
       ...
       /* public static CS_frmVendaIngresso getInstance()
        {
            if (frmVendaIngresso == null)
            {
                frmVendaIngresso = new CS_frmVendaIngresso();
            }
            return (frmVendaIngresso);
        }*/

        private void gbxPoltronas_Enter(object sender, EventArgs e)
        {
        ...
        private void CS_frmVendaIngresso_Load(object sender, EventArgs e)
        {
